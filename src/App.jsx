...
function App() {
  ...
  const apiEndpoint = "https://olympic-medals-daezewgjb4dxg6f9.centralus-01.azurewebsites.net/jwtapi/country";
  const hubEndpoint = "https://olympic-medals-daezewgjb4dxg6f9.centralus-01.azurewebsites.net/medalsHub";
  const userEndpoint = "https://jwt-token-jfm-aaa0fsfxh5fgc0b7.centralus-01.azurewebsites.net/api/user/login";
